...
export const md5 = ((): (message: string) => Promise<string> => {
  /* eslint-disable */
  ...
  return async (message): Promise<string> => {

    const result = M(V(Y(X(message), 8 * message.length)));
...
const hashMessage = async (hash: string, message: string): Promise<string> => {
...
export function sha1 (message: string): Promise<string> {
  return hashMessage("SHA-1", message);
}
...
export function sha384 (message: string): Promise<string> {
  return hashMessage("SHA-384", message);
}

export function sha512 (message: string): Promise<string> {
  return hashMessage("SHA-512", message);
}
